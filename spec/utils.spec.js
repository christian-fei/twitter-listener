...
var mySignature = utils.concatProperties( signatureParams );
var mySignatureBaseString = utils.concatPropertiesBaseString('post','https://api.twitter.com/1/statuses/update.json', mySignature);
...
var validOauthSignature = "tnnArxj06cWHq44gCs1OSKk/jLY=";
var validAuthString = 'OAuth oauth_consumer_key="xvz1evFS4wEEPTGEFPHBog", oauth_nonce="kYjzVBB8Y0ZFabxSWbWovY3uYSQ2pTgmZeNu2VS4cg", oauth_signature="tnnArxj06cWHq44gCs1OSKk%2FjLY%3D", oauth_signature_method="HMAC-SHA1", oauth_timestamp="1318622958", oauth_token="370773112-GmHxMAgYyLbNEtIKZeRNFsMKPR9EyMZeS9weJAEb", oauth_version="1.0"';
...
describe('utils', function(){
  ...
  it('should create a valid oauth signature', function(){
    expect( myOauthSignature ).toEqual( validOauthSignature );
  })

  it('should create a valid auth string', function(){
    expect( myAuthString ).toEqual( validAuthString );
  })
